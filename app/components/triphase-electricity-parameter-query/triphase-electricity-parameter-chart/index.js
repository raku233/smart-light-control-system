...
export default class TriphaseElectricityParameterChart extends Component {
    ...
    render() {
        const { loading, devID, couldPeriodConfig, startTime, endTime, chartType, statusType } = this.props;
        console.log('render', this.props);

        return (
            <div className="c-tepq-tepc-container">
                <QueueAnim className="c-tepq-tepc-anim-wrapper" delay={100} interval={200} type={['right', 'left']} ease={['easeOutQuart', 'easeInOutQuart']}>
                    { devID ? [
                        <div key="config" className="c-tepq-tepc-config-group">
